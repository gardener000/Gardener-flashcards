  ...
  data: [
    {
      ...
      back: `<div style="font-family: Arial, sans-serif; background-color: #ffffff; color: #2c3e50; padding: 20px; border-radius: 10px; border: 1px solid #e0e0e0; line-height: 1.6;">
              <dl>
                ...
                <dd>在共享介质（如广播信道）上，如何协调多个设备，决定 <mark style="background-color: #d6eaf8; border-radius: 3px; padding: 2px 4px;">谁获得信道使用权</mark>，以避免数据冲突。</dd>
                <dt style="color: #2980b9; font-weight: bold; font-size: 1.1em;">两种信道</dt>
                <dd><strong>点对点:</strong> 专用线路，无竞争。<br><strong>广播信道:</strong> 共享介质，是MAC层关注的重点。</dd>
    ...
    },
    {
      ...
      back: `<div style="font-family: Arial, sans-serif; background-color: #ffffff; color: #2c3e50; padding: 20px; border-radius: 10px; border: 1px solid #e0e0e0; line-height: 1.6;">
              <dl>
                ...
                <dd><strong>方法:</strong> 预先划分资源，如FDMA（频分）。<br><strong>优点:</strong> 简单，无冲突。<br><strong>缺点:</strong> 浪费严重！不适合计算机网络的 <mark style="background-color: #fdebd0; border-radius: 3px; padding: 2px 4px;">突发性(Bursty)</mark> 流量。</dd>
    ...
    },
    {
      ...
      back: `<div style="font-family: Arial, sans-serif; background-color: #ffffff; color: #2c3e50; padding: 20px; border-radius: 10px; border: 1px solid #e0e0e0; line-height: 1.6;">
              <dl>
                ...
                <dd><strong>ρ (利用率):</strong> 信道有多忙碌。<br><strong>T (平均延迟):</strong> 发送一帧的平均总时间。</dd>
    ...
    },
    {
      ...
      back: `<div style="font-family: Arial, sans-serif; background-color: #ffffff; color: #2c3e50; padding: 20px; border-radius: 10px; border: 1px solid #e0e0e0; line-height: 1.6;">
              <dl>
                ...
                <dd>思想简单：“想发就发”，冲突后随机等待重传。</dd>
                <dt style="color: #c0392b; font-weight: bold; font-size: 1.1em;">纯 ALOHA (Pure ALOHA)</dt>
                <dd><strong>规则:</strong> 任意时刻可发送。<br><strong>脆弱期:</strong> <mark style="background-color: #fadbd8; border-radius: 3px; padding: 2px 4px;">2t</mark> (t为帧发送时间)。<br><strong>最大效率:</strong> 仅 <mark style="background-color: #fadbd8; border-radius: 3px; padding: 2px 4px;">18.4%</mark>。</dd>
    ...
    },
    {
      ...
      back: `<div style="font-family: Arial, sans-serif; background-color: #ffffff; color: #2c3e50; padding: 20px; border-radius: 10px; border: 1px solid #e0e0e0; line-height: 1.6;">
              <dl>
                ...
                <dd>Carrier Sense (载波侦听) - <mark style="background-color: #e8daef; border-radius: 3px; padding: 2px 4px;">“先听再说”</mark>，极大减少冲突。</dd>
                <dt style="color: #8e44ad; font-weight: bold; font-size: 1.1em;">1-坚持 (1-persistent)</dt>
                <dd><strong>策略:</strong> 信道忙则一直听，一空闲就 <mark style="background-color: #e8daef; border-radius: 3px; padding: 2px 4px;">立即发送</mark>。<br><strong>特点:</strong> 贪婪，高负载时易冲突。</dd>
                <dt style="color: #8e44ad; font-weight: bold; font-size: 1.1em;">非坚持 (Non-persistent)</dt>
                <dd><strong>策略:</strong> 信道忙则 <mark style="background-color: #e8daef; border-radius: 3px; padding: 2px 4px;">放弃并随机等待</mark> 后再听。<br><strong>特点:</strong> 礼貌，高负载性能好，但可能浪费信道。</dd>
    ...
    },
    {
      ...
      back: `<div style="font-family: Arial, sans-serif; background-color: #ffffff; color: #2c3e50; padding: 20px; border-radius: 10px; border: 1px solid #e0e0e0; line-height: 1.6;">
              <dl>
                ...
                <dd>Collision Detection (冲突检测) - 不仅“先听再说”，还要 <mark style="background-color: #d1f2eb; border-radius: 3px; padding: 2px 4px;">“边说边听”</mark>。</dd>
                <dt style="color: #16a085; font-weight: bold; font-size: 1.1em;">工作原理</dt>
                <dd>一旦检测到冲突，<mark style="background-color: #d1f2eb; border-radius: 3px; padding: 2px 4px;">立即停止发送</mark>，极大减少了冲突开销。</dd>
